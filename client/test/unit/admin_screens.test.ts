...
describe('missingLayouts', () => {
  it.each<{
    ...
    },
    {
      ...
      screens: [screen(1n, 'list'), screen(2n, 'grid'), screen(4n, 'project')],
      all: LAYOUTS,
      want: ['kanban'],
    },
    {
    ...
    },
    {
      ...
      all: ['project', 'list', 'grid', 'kanban'] as const,
      want: ['project', 'list', 'grid'],
    },
    {
      label: 'screens with no layout attribute are ignored',
      screens: [card(1n, {}), screen(2n, 'list')],
      all: LAYOUTS,
      want: ['grid', 'kanban', 'project'],
    },
