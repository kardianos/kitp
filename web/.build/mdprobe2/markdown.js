...
g.setOptions({ async: false, gfm: true, breaks: true });
var ALLOWED_TAGS = [
  // Block
  "h1",
  "h2",
...
function renderMarkdown(source) {
  if (source === "") return "";
  const raw = g.parse(source);
  const html2 = typeof raw === "string" ? raw : "";
  return String(purify.sanitize(html2, SANITIZE_CONFIG));
}
export {
  renderMarkdown
};
